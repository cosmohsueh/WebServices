 ...
 * generated in the com.cosmo.ws.binary.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _DownloadResponse_QNAME = new QName("http://server.binary.ws.cosmo.com/", "downloadResponse");
    private final static QName _UploadResponse_QNAME = new QName("http://server.binary.ws.cosmo.com/", "uploadResponse");
    private final static QName _Download_QNAME = new QName("http://server.binary.ws.cosmo.com/", "download");
    private final static QName _Upload_QNAME = new QName("http://server.binary.ws.cosmo.com/", "upload");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cosmo.ws.binary.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.cosmo.com/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.cosmo.com/", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.cosmo.com/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.cosmo.com/", name = "upload")
