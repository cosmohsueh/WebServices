 ...
 * 
 */
@WebServiceClient(name = "FileTransfererImplService", targetNamespace = "http://server.binary.ws.cosmo.com/", wsdlLocation = "http://localhost:9898/cosmo/fileService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FILETRANSFERERIMPLSERVICE_QNAME = new QName("http://server.binary.ws.cosmo.com/", "FileTransfererImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9898/cosmo/fileService?wsdl");
    ...
    public FileTransfererImpl getFileTransfererImplPort() {
        return super.getPort(new QName("http://server.binary.ws.cosmo.com/", "FileTransfererImplPort"), FileTransfererImpl.class);
    }
    ...
    public FileTransfererImpl getFileTransfererImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.binary.ws.cosmo.com/", "FileTransfererImplPort"), FileTransfererImpl.class, features);
    }
