 ...
 * generated in the com.cosmo.webservices.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _HashString_QNAME = new QName("http://server.webservices.cosmo.com/", "hashString");
    private final static QName _HashStringResponse_QNAME = new QName("http://server.webservices.cosmo.com/", "hashStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cosmo.webservices.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservices.cosmo.com/", name = "hashString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservices.cosmo.com/", name = "hashStringResponse")
